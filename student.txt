...
void print(struct stud *pt)
{
    int j;
    printf("%-15s",pt->num);
    printf("%-15s",pt->name);
    if(pt->sex=='m')printf("male        ");
    else printf("female      ");
    printf("%d",pt->birth.year);
    if(pt->birth.month<10)printf("-0%d",pt->birth.month);
...
void sort()
{
    ...
    printf("number         name           sex            birth           score1         score2         score3         average        \n");
    for(;p<stu+N;p++)
    {
        print(p);
        if(p!=stu+3)printf("\n");
